...
ROOT_PATH = os.getcwd()
PATH_NOISE = ROOT_PATH + '/data/Aurora'
PATH_TRAIN = ROOT_PATH + '/data/Training/modi'
...
# =============================================================================
standard_wav,rate = librosa.load(PATH_TRAIN+'/train0000.wav', sr=None)
...
for noiseFile in [f for f in listdir(PATH_NOISE) if f.endswith(".wav")]:
 ...
 noise_wav = equalizingRMS(standard_wav,noise_wav) #standard_wav 와 noise_wav 의 RMS 를
같도록
